...
// Adapté à react-resizable-panels v4 (bump PR #14) :
// - PanelGroup → Group, PanelResizeHandle → Separator (Panel inchangé) ;
// - prop « direction » (v3) → « orientation » (v4) ;
// - v4 pose aria-orientation sur le Separator lui-même (plus de
//   data-panel-group-direction) — les sélecteurs CSS suivent.
