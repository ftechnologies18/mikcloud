...
export const enAnnouncements: Record<string, string> = {
  ...
  "ann.fallbackNoExpiry": "The server doesn't support hour-based durations yet (backend pending redeploy) — the announcement was created without expiry.",
  ...
  "ann.form.levelHint": "Drives the client banner color: gray (information), green (new feature), teal (maintenance), amber (action recommended), red (incident — takes priority in the banner).",
  ...
  "ann.form.expiry.day": "{n} day",
  "ann.form.expiry.hours": "{n} hours",
  "ann.form.expiry.none": "Until manual removal",
  "ann.form.expiry.custom": "Custom duration…",
  "ann.form.expiry.daysField": "Days",
  "ann.form.expiry.hoursField": "Hours",
  "ann.form.expiry.total": "That is {n} of visibility in total.",
  "ann.form.expiryCustomInvalid": "The duration must range from 1 hour to 365 days.",
  "ann.form.expiryHint": "After this window the announcement disappears from consoles on its own. Short maintenance? Pick an hour-based duration.",
  ...
  "ann.banner.remaining": "({duration} left)",
};
