...
export const frProtection: Record<string, string> = {
  ...
  "protection.ofModules": "{n}/3 protections actives",
  ...
  "protection.summary.desc": "Sites dangereux, anti-piratage et couvre-feu se pilotent désormais depuis la vue Protection.",
