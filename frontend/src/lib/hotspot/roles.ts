...
const PLATFORM_VIEWS: ReadonlySet<string> = new Set(["platform", "platformFleet", "platformChat", "platformLogs", "platformTeam", "billingRequests", "platformSettings", "platformAnnouncements", "platformNotifications"]); // N°153 — notifications du compte principal
